...
// 统一 Decision feed API
// Latest verdict per tracked symbol (crypto + equity unified). Optional
// assetClass ('crypto' | 'equity') narrows the feed server-side.
...
export const getDecisionHistory = (symbol, limit = 100) =>
  api.get(`/decisions/${encodeURIComponent(symbol)}`, { params: { limit } })
